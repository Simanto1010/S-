      ...
      <AnimatePresence>
        {(isListening || isSpeaking || isProcessing) && (
          <motion.div
            ...
            className="bg-black/90 backdrop-blur-xl border border-white/10 p-6 rounded-3xl shadow-2xl flex flex-col items-center gap-4 min-w-[300px]"
          >
            ...
            <div className="flex items-center justify-center gap-1 h-12">
              {[...Array(12)].map((_, i) => (
                <motion.div
                  key={i}
                  animate={{
                    height: (isListening || isSpeaking) ? [10, 40, 10] : 4,
            ...
            {transcript && (
              <div className="text-white text-sm text-center italic max-w-[250px] truncate">
                "{transcript}"
              </div>
            )}
